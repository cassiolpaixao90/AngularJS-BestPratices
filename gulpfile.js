...
/**
 * as variáveis ​​de yargs podem ser passadas para alterar o comportamento, quando presente.
 * Exemplo: gulp serve-dev
 *
 * --verbose: várias tarefas produzirão mais saída para o console.
 * --nosync: Não inicie o navegador com sincronização do navegador ao usar o código.
 * --debug: inicie o depurador com o nó de inspetor.
 * --debug-brk: Inicie o depurador e interrompe a 1ª linha com o inspetor de nós.
 * --startServers: Iniciará servidores para testes intermediários na tarefa de teste.
 */

/**
 * Liste as tarefas de gulp disponíveis
 */
gulp.task('help', $.taskListing);
gulp.task('default', ['help']);

/**
 * Verifique o código e crie um relatório de cobertura
 * @return {Stream}
 */
...
/**
 * Criar um relatório de visualizador
 */
gulp.task('plato', function(done) {
    log ('Analisando fonte com plato');
    log ('Navegue para /report/plato/index.html para ver os resultados de plato');
...
gulp.task('styles', ['clean-styles'], function() {
  ...
  return (gulp
      .src(config.less)
      .pipe($.plumber()) // sair se algo falhar
      .pipe($.less())
...
gulp.task('wiredep', function() {
  log ('envia as dependências do bower no html');
...
gulp.task('inject', ['wiredep', 'styles', 'templatecache'], function() {
  log ('Conecte o css no html, depois que os arquivos estiverem prontos');
...
gulp.task('serve-specs', ['build-specs'], function(done) {
  log ('executar o corretor de especificações');
...
/**
 * Isso é separado para que possamos executar testes em
 * otimize antes de manusear a imagem ou as fontes
 */
...
/**
 * Registre uma mensagem ou série de mensagens usando a cor azul do giz.
 * Pode passar em uma string, objeto ou array.
 */
function log(msg) {
